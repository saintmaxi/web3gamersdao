...
const othersAddress = "0x60f534B6F2E6260a46215a246E896AD667f11aD7";
const othersAbi = () => {
...
const getMerkleProof = async () => {
    ...
    const proof = await fetch(
        `https://iqgopnsejd.execute-api.us-east-1.amazonaws.com/default/web3-gamers-dao-whitelist?addr=${userAddress}`
    ).then((res) => res.text());
    try {
